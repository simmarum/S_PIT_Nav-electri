...
public class AttractionPosition extends Position {
    ...
    public AttractionPosition(Context context, double lat, double lon, String title, String snip, Integer icon,Boolean sponsor,Boolean code, String today_open_hours, String telephone,double distance) {
